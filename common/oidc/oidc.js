/**
 * JavaScript functions for providing OpenID Connect
 * 
 * Copyright (C) 2021 F5, Inc.
 */
 ...
 * @returns {string} query parameters of authorization endpoint
 */
 ...
 * 
 * @param r {Request} HTTP request object
 * @param obj {string} custom query parameters
 * @returns {string} custom query parameters
 */
 ...
 * 
 * - As-Is: return only a value for Accept-Encoding.
 * - TODO: Dynamically add custom header parameters
 * 
 * @param r {Request} HTTP request object
 * @param obj {string} custom header parameters
 * @returns {string} custom header value
 */
 ...
 * 
 * @param r {Request} HTTP request object
 * @returns {string} query parameters of oidc end session endpoint
 */
 ...
 * 
 * @param r {Request} HTTP request object
 * @returns {string} query parameters of token endpoint
 */
 ...
 * 
 * @param r {Request} HTTP request object
 * @returns {boolean} code validation result
 */
 ...
 * 
 * @param r {Request} HTTP request object
 * @param msgPrefix {string} message prefix
 * @returns {boolean} claim validation result
 */
 ...
 * @param r {Request} HTTP request object
 * @param msgPrefix {string} message prefix
 * @param missingClaims {object} list of missing claims in the token
 * @returns {boolean} claim validation result
 */
 ...
 * 
 * @param r {Request} HTTP request object
 * @param tokenset {object} token endpoint response body
 * @returns {boolean} token set validation result
 */
 ...
 * 
 * @param r {Request} HTTP request object
 * @returns {boolean} session validation result
 */
 ...
 * 
 * @param r {Request} HTTP request object
 * @returns {boolean} result if client_id is part of cookies
 */
